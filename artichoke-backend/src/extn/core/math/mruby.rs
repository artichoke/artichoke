...
unsafe extern "C" fn artichoke_math_acos(
    ...
    let result = math::acos(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
...
unsafe extern "C" fn artichoke_math_acosh(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::acosh(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_asin(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::asin(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_asinh(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::asinh(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_atan(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::atan(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_atan2(
    ...
    let result = math::atan2(&mut guard, value, other).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_atanh(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::atanh(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_cbrt(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::cbrt(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_cos(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::cos(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_cosh(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::cosh(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_erf(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::erf(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_erfc(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::erfc(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_exp(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::exp(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_gamma(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::gamma(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_hypot(
    ...
    let value = Value::new(&guard, value);
    let other = Value::new(&guard, other);
    let result = math::hypot(&mut guard, value, other).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_ldexp(
    ...
    let result =
        math::ldexp(&mut guard, fraction, exponent).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_log(
    ...
    let result = math::log(&mut guard, value, base).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_log10(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::log10(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_log2(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::log2(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_sin(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::sin(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_sinh(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::sinh(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_sqrt(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::sqrt(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_tan(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::tan(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
...
unsafe extern "C" fn artichoke_math_tanh(
    ...
    let mut guard = Guard::new(&mut interp);
    let value = Value::new(&guard, value);
    let result = math::tanh(&mut guard, value).map(|result| interp.convert_mut(result));
    match result {
        Ok(value) => value.inner(),
        Err(exception) => exception::raise(guard, exception),
    }
