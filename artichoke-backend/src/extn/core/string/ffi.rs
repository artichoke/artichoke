...
// ```
#[no_mangle]
unsafe extern "C-unwind" fn mrb_str_new_capa(mrb: *mut sys::mrb_state, capa: usize) -> sys::mrb_value {
...
// ```
#[no_mangle]
unsafe extern "C-unwind" fn mrb_str_new(mrb: *mut sys::mrb_state, p: *const c_char, len: usize) -> sys::mrb_value {
    unwrap_interpreter!(mrb, to => guard);
    let s = if p.is_null() {
