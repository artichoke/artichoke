...
pub fn init(interp: &mut Artichoke) -> InitializeResult<()> {
    ...
    class::Builder::for_spec(interp, &nomemory_spec)
        .with_super_class::<Exception>("Exception")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &load_spec)
        .with_super_class::<ScriptError>("ScriptError")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &interrupt_spec)
        .with_super_class::<SignalException>("SignalException")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &uncaughthrow_spec)
        .with_super_class::<ArgumentError>("ArgumentError")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &eof_spec)
        .with_super_class::<IOError>("IOError")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &key_spec)
        .with_super_class::<IndexError>("IndexError")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &nomethod_spec)
        .with_super_class::<NameError>("NameError")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &floatdomain_spec)
        .with_super_class::<RangeError>("RangeError")?
        .define()?;
    ...
    class::Builder::for_spec(interp, &frozen_spec)
        .with_super_class::<RuntimeError>("RuntimeError")?
        .define()?;
