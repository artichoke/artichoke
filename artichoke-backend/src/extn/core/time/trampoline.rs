...
pub fn at<T>(interp: &mut Artichoke, args: T) -> Result<Value, Exception>
where
...
pub fn mkutc<T>(interp: &mut Artichoke, args: T) -> Result<Value, Exception>
where
    T: IntoIterator<Item = Value>,
{
    let _ = interp;
...
pub fn mktime<T>(interp: &mut Artichoke, args: T) -> Result<Value, Exception>
where
    T: IntoIterator<Item = Value>,
{
    let _ = interp;
...
pub fn to_int(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn to_float(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn to_rational(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    // Requires `Rational`
    Err(NotImplementedError::new().into())
...
pub fn cmp(interp: &mut Artichoke, time: Value, other: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    let _ = other;
    Err(NotImplementedError::new().into())
...
pub fn eql(interp: &mut Artichoke, time: Value, other: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    let _ = other;
    Err(NotImplementedError::new().into())
...
pub fn hash(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn initialize<T>(interp: &mut Artichoke, time: Value, args: T) -> Result<Value, Exception>
where
    T: IntoIterator<Item = Value>,
{
    let _ = interp;
...
pub fn mutate_to_utc(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}
...
pub fn as_utc(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}
...
pub fn asctime(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn to_string(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn to_array(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}
...
pub fn plus(interp: &mut Artichoke, time: Value, other: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    let _ = other;
    Err(NotImplementedError::new().into())
...
pub fn minus(interp: &mut Artichoke, time: Value, other: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    let _ = other;
    Err(NotImplementedError::new().into())
...
pub fn succ(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}
...
pub fn is_dst(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn timezone(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}

pub fn utc_offset(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}
...
pub fn is_utc(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    Err(NotImplementedError::new().into())
}
...
pub fn subsec(interp: &mut Artichoke, time: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    // Requires `Rational`
    Err(NotImplementedError::new().into())
...
pub fn strftime(interp: &mut Artichoke, time: Value, format: Value) -> Result<Value, Exception> {
    let _ = interp;
    let _ = time;
    let _ = format;
    // Requires a parser.
