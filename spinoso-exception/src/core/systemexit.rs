...
impl SystemExit {
    /// Construct a new, default `SystemExit` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for SystemExit {
    #[inline]
...
impl From<Vec<u8>> for SystemExit {
    #[inline]
...
impl From<Cow<'static, [u8]>> for SystemExit {
    #[inline]
...
impl fmt::Display for SystemExit {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for SystemExit {}
