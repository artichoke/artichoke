...
impl SystemStackError {
    /// Construct a new, default `SystemStackError` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for SystemStackError {
    #[inline]
...
impl From<Vec<u8>> for SystemStackError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for SystemStackError {
    #[inline]
...
impl fmt::Display for SystemStackError {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for SystemStackError {}
