...
impl SignalException {
    /// Construct a new, default `SignalException` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for SignalException {
    #[inline]
...
impl From<Vec<u8>> for SignalException {
    #[inline]
...
impl From<Cow<'static, [u8]>> for SignalException {
    #[inline]
...
impl fmt::Display for SignalException {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for SignalException {}
