...
impl EOFError {
    /// Construct a new, default `EOFError` Ruby exception.
    ///
...
impl From<&'static str> for EOFError {
    #[inline]
...
impl From<Cow<'static, str>> for EOFError {
    #[inline]
...
impl From<&'static [u8]> for EOFError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for EOFError {
    #[inline]
