...
impl EncodingError {
    /// Construct a new, default `EncodingError` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for EncodingError {
    #[inline]
...
impl From<Vec<u8>> for EncodingError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for EncodingError {
    #[inline]
