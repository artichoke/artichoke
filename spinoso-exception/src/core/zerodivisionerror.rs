...
impl ZeroDivisionError {
    /// Construct a new, default `ZeroDivisionError` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for ZeroDivisionError {
    #[inline]
...
impl From<Vec<u8>> for ZeroDivisionError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for ZeroDivisionError {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for ZeroDivisionError {}
