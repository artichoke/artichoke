...
impl NameError {
    /// Construct a new, default `NameError` Ruby exception.
    ///
    /// This constructor sets the exception message to `NameError`.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// assert_eq!(exception.message(), b"NameError");
    /// ```
    #[inline]
    #[must_use]
    ...
    /// let exception = NameError::new();
    /// assert_eq!(exception.message(), b"NameError");
    /// let exception = NameError::from("something went wrong");
...
impl From<String> for NameError {
    #[inline]
...
impl From<&'static str> for NameError {
    #[inline]
...
impl From<Cow<'static, str>> for NameError {
    #[inline]
...
impl From<Vec<u8>> for NameError {
    #[inline]
...
impl From<&'static [u8]> for NameError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for NameError {
    #[inline]
