...
impl ThreadError {
    /// Construct a new, default `ThreadError` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for ThreadError {
    #[inline]
...
impl From<Vec<u8>> for ThreadError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for ThreadError {
    #[inline]
