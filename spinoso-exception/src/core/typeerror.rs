...
impl TypeError {
    /// Construct a new, default `TypeError` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for TypeError {
    #[inline]
...
impl From<Vec<u8>> for TypeError {
    #[inline]
...
impl From<&'static [u8]> for TypeError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for TypeError {
    #[inline]
