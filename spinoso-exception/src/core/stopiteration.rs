...
impl StopIteration {
    /// Construct a new, default `StopIteration` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for StopIteration {
    #[inline]
...
impl From<Vec<u8>> for StopIteration {
    #[inline]
...
impl From<Cow<'static, [u8]>> for StopIteration {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for StopIteration {}
