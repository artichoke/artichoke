...
impl NotImplementedError {
    /// Construct a new, default `NotImplementedError` Ruby exception.
    ///
    /// This constructor sets the exception message to `NotImplementedError`.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// assert_eq!(exception.message(), b"NotImplementedError");
    /// ```
    #[inline]
    #[must_use]
    ...
    /// let exception = NotImplementedError::new();
    /// assert_eq!(exception.message(), b"NotImplementedError");
    /// let exception = NotImplementedError::from("something went wrong");
...
impl From<Cow<'static, str>> for NotImplementedError {
    #[inline]
...
impl From<Vec<u8>> for NotImplementedError {
    #[inline]
...
impl From<&'static [u8]> for NotImplementedError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for NotImplementedError {
    #[inline]
