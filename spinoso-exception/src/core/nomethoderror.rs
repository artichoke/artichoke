...
impl NoMethodError {
    /// Construct a new, default `NoMethodError` Ruby exception.
    ///
...
impl From<Vec<u8>> for NoMethodError {
    #[inline]
...
impl fmt::Display for NoMethodError {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for NoMethodError {}
