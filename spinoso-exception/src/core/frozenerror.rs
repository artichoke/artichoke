...
impl FrozenError {
    /// Construct a new, default `FrozenError` Ruby exception.
    ///
...
impl From<Cow<'static, str>> for FrozenError {
    #[inline]
...
impl From<Vec<u8>> for FrozenError {
    #[inline]
...
impl From<Cow<'static, [u8]>> for FrozenError {
    #[inline]
...
#[cfg(feature = "std")]
impl error::Error for FrozenError {}
